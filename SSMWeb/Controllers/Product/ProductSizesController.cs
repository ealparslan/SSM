...
namespace SSMWeb.Controllers
{
    public class ProductSizesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Dimentions,Property1,IsEnabled")] ProductSize productSize)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Dimentions,Property1,IsEnabled")] ProductSize productSize)
        {
            if (ModelState.IsValid)
            {
