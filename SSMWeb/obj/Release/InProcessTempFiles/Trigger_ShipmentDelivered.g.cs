...
namespace SSMWeb.DB_Scripts {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class Trigger_ShipmentDelivered : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public Trigger_ShipmentDelivered() {
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(Trigger_ShipmentDelivered).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(Trigger_ShipmentDelivered));
        ...
        private string FindResource() {
            string[] resources = typeof(Trigger_ShipmentDelivered).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".Trigger_ShipmentDelivered.g.xaml") || resource.Equals("Trigger_ShipmentDelivered.g.xaml"))) {
                    return resource;
                }
            }
